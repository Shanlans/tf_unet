...
def depthwise_conv2d(x, W,keep_prob_):
    conv_2d = tf.nn.depthwise_conv2d(input=x, filter=W, strides=[1,1,1,1], rate=[1,1], padding='SAME')
    return tf.nn.dropout(conv_2d, keep_prob_)
...
def pixel_wise_softmax_2(output_map):
    ...
    return tf.div(exponential_map,tensor_sum_exp,name='PredictProb')
